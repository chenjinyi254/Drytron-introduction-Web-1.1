...
class Core_Lib_Page
{
    ...
    protected function _set_url()
    {
        ...
        if(isset($parse['query'])) {
            $parse['query'] = str_replace('index.php','&',$parse['query']);
     ...
     * @return string
     */
    public function last_page($name = 'Fanal Page')
    {
    ...
    protected function show_3()
    {
        ...
        $begin = ($begin >= 1) ? $begin : 1;
        $return = 'Toatl Page ' .$this->total_rows. ' is ' .$this->total_pages. ' page, now it is ' . $this->now_page . ' page ';
        $return .= ',each page ';
